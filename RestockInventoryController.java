...
public class RestockInventoryController {
    ...
    private void handleRestock(ActionEvent event) {
        ...
        try {
            // Update stock
            inventoryDAO.updateStock(selectedItem.getItemId(), quantity);

            // Log restock
            inventoryDAO.insertRestockRecord(selectedItem.getItemId(), quantity, restocker.getPersonnelId(), remarks);
