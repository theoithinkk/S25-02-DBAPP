...
public class ServiceTransactionDAO {
    ...
    public boolean addTransaction(ServiceTransaction t) {
        String sql = "INSERT INTO ServiceTransactions (service_id, resident_id, personnel_id, date_provided, remarks) " +
                "VALUES (?, ?, ?, ?, ?)";
    ...
    public List<ServiceTransaction> getAllTransactions() {
        ...
        String sql = "SELECT st.transaction_id, st.date_provided, st.remarks, " +
